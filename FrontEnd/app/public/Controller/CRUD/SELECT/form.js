const apiUrl = 'https://localhost:44329/api/Form'; // Cambia por tu endpoint real
...
document.getElementById('btnCrear').addEventListener('click', () => {
    ...
    fetch(apiUrl, {
        ...
        .then((data) => {
            ...
            alertSuccess(`Form "${data.name}" creado exitosamente`);
            limpiarFormulario();
            cargarRegistros();
        })
...
document.getElementById('btnActualizar').addEventListener('click', () => {
    ...
    fetch(`${apiUrl}/${idActual}`, {
        ...
        .then(data => {
            ...
            // mostrarMensaje(data.message || 'Formulario actualizado correctamente');
            limpiarFormulario();
            cargarRegistros();
        })
        .catch(err => {
            mostrarMensajeError(err.message); // Mostrar el mensaje de error
        });
});

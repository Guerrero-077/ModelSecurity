const apiUrl = 'https://localhost:44329/api/rol'; // Cambia por tu endpoint real
...
document.getElementById('btnCrear').addEventListener('click', () => {
    ...
    fetch(apiUrl, {
        ...
        .then((data) => {
            console.log(data);
            alertSuccess(`Rol "${data.name}" creado exitosamente`);
            limpiarFormulario();
            cargarRegistros();
        })
...
document.getElementById('btnActualizar').addEventListener('click', () => {
    ...
    fetch(`${apiUrl}/${idActual}`, {
        ...
        .then(data => {
            ...
            // mostrarMensaje(data.message || 'Module actualizado correctamente');
            limpiarFormulario();
            cargarRegistros();
        })
        .catch(err => {
